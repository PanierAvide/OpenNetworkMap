...
/**
 * A spatializable object can be put in a two-dimensional space.
 */
public interface Spatializable {
	/**
	 * @return The object latitude (Vertical coordinate)
	 */
	double getLatitude();
	
	/**
	 * @return The object longitude (Horizontal coordinate)
	 */
	double getLongitude();
}
